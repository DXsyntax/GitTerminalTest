...
# DISSECT THIS BLOCK BY BLOCK, THIS IS GOING TO TAKE AWHILE. SO DON'T WORRY ABOUT TRYING TO FINISH THIS IN 1 SHOT 
# ASSIGNMENT: 
              # spot functions 
              # plot out the control flow 
              # spot out statements of any kinds 
              # spot out data structures used 
              # list out the purposes of the functions and statements used
              # spot where are all the logic at work. put them into a list 
